class Comment < ActiveRecord::Base
  ...
  COMMENTABLE_TYPES = %w(Debate Proposal SpendingProposal ProbeOption Budget::Investment Poll::Question Legislation::Question Legislation::Annotation Topic).freeze
