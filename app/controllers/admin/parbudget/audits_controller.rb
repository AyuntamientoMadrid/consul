class Admin::Parbudget::AuditsController < Admin::Parbudget::BaseController
    skip_before_filter :get_model
    load_and_authorize_resource :audit, class: "Audit"

    has_filters %w{all ambits centers projects responsibles meetings topics }
    ...
    private
      ...
      def search(parametrize = {})
          @audits = Audit.all.where(audit_type: "parbudget")
          @filters = []
